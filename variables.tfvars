...
#
#
master = {name = "master", profile_id = "bp2-2x8", fip_name = "master-x-fip", count = "1"}
infra = {name = "infra", profile_id = "bp2-2x8", fip_name = "infra-x-fip", count = "1"}
worker = {name = "worker", profile_id = "bp2-2x8", fip_name = "worker-x-fip", count = "1"}
